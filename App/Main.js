let LinkCert6 = document.getElementById("Cer6");
...
let _appTable = document.getElementById("BtnTableUsers");
...
const OpenLink6 = () => {
    LinkCert6.addEventListener("click" , function(){
        window.open("https://www.udemy.com/certificate/UC-ee5ad87b-0872-439f-9de6-d829d1ef9e0f/", "_blank");
    });
}
...
const OpenTable = () => {
    _appTable.addEventListener("click" ,  function(){
